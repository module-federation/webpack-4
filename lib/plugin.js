...
const Inject = require("inject-webpack")
 module.exports = class ModuleFederationPlugin {
   ...
   genVirtualModule(compiler) {
    const vir = new VirtualModulesPlugin()
    vir.apply(compiler);
    vir.writeModule(virtualInitConfigPath, getInitConfigModule(this))
    vir.writeModule(virtualLocalSharedPath, getSharedModule(this))
    // runtimeFetchContainer.call
    vir.writeModule(virtualSetSharedPath, getSetSharedModule(this))
    vir.writeModule(virtualExposesPath, getExposesModule(this))
   }
