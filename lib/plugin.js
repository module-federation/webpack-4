 ...
 */
 ...
 const { stringifyHasFun, injectRefreshLoader, getUsedWpmPackages, getEntrysPath } = require("./utils/utils");
...
const { default: expandShared } = require("./utils/expandShared");
 ...
 module.exports = class MFWebpack4 {
   constructor (options = {}) {
     ...
     options.shared = expandShared(options.shared, options.name, options.sharedScope)
     if (!options.name) {
